...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Create inference segmentor objects. Loading the TF Lite model takes time, so this is done
    ...
    void createTFLiteClassifiersAsync() {
        ...
        backgroundTaskExecutor.execute(
                () -> {
                    // Create a SemanticSegmentation object with all available compute units (NPU,
                    // GPU, CPU)
